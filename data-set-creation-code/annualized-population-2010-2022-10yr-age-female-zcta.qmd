...
subtitle: "<u>ANNUALIZED POPULATION ESTIMATES BY SEX, ZCTA, 2010-2022</u>: <i>Steps for calculating annual population estimates using decennial data for rate denominators</i>"
...
dbWriteTable(con_inter_census,
         Id(schema = "ref", table = "annualized-population-2010-2022-10yr-age-sex-zcta"),
         overwrite = TRUE,
