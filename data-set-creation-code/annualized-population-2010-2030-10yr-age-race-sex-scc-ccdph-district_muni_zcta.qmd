...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_district <- standard_age_groups_seer %>% 
  left_join(pop_2010_district_total_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_district_total_10yr, by=c("order_age_10yr","name_district"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_district_10yr <- standard_age_groups_seer_pop_district %>% 
  group_by(name_district, 
           order_age_10yr,
           name_age_10yr) %>% 
  summarise(pop_2010 = sum(pop_2010),
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_district_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_district_10yr_annualized")
standard_age_groups_seer_pop_district_10yr_annualized <- standard_age_groups_seer_pop_district_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_district_total_10yr, 
   pop_2020_district_total_10yr,
   standard_age_groups_seer_pop_district_10yr)
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_race_district <- standard_age_groups_seer %>% 
  left_join(pop_2010_district_race_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_district_race_10yr, by=c("order_age_10yr","name_district","race"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_race_district_10yr <- standard_age_groups_seer_pop_race_district %>% 
  group_by(name_district, 
           order_age_10yr,
           name_age_10yr,
           race) %>% 
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_race_district_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_race_district_10yr_annualized")
standard_age_groups_seer_pop_race_district_10yr_annualized <- standard_age_groups_seer_pop_race_district_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_district_race_10yr, 
   pop_2020_district_race_10yr,
   standard_age_groups_seer_pop_race_district_10yr)
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_sex_district <- standard_age_groups_seer %>% 
  left_join(pop_2010_district_sex_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_district_sex_10yr, by=c("order_age_10yr","name_district","sex"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_sex_district_10yr <- standard_age_groups_seer_pop_sex_district %>% 
  group_by(name_district, 
           order_age_10yr,
           name_age_10yr,
           sex) %>% 
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_sex_district_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_sex_district_10yr_annualized")
standard_age_groups_seer_pop_sex_district_10yr_annualized <- standard_age_groups_seer_pop_sex_district_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_district_sex_10yr, 
   pop_2020_district_sex_10yr,
   standard_age_groups_seer_pop_sex_district_10yr)
...
# Health district
standard_age_groups_seer_district_10yr_annualized_all <- standard_age_groups_seer_pop_district_10yr_annualized %>%
  mutate(stratification = "total") %>% 
  bind_rows(
    standard_age_groups_seer_pop_race_district_10yr_annualized %>%
      rename(stratification = race)
    ) %>%
  bind_rows(
    standard_age_groups_seer_pop_sex_district_10yr_annualized %>%
      rename(stratification = sex)
    ) %>% 
  mutate(geoid = name_district,
         layer = "region")
...
standard_age_groups_seer_10yr_annualized_all <- 
  ...
  bind_rows(standard_age_groups_seer_district_10yr_annualized_all) %>%
...
dbWriteTable(con_inter_census,
         Id(schema = "ref", table = "annualized-decennial-2010-2030-10yr-age-by-race-sex-scc-ccdph-district-muni-zcta"),
         overwrite = TRUE,
