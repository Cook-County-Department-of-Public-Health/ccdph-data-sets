...
## Muni total population with SEER rates
...
## ZCTA total population with SEER rates
...
standard_age_groups_seer_10yr_annualized_all <- 
  ...
  bind_rows(standard_age_groups_seer_scc_pop_muni_10yr_annualized) %>%
  bind_rows(standard_age_groups_seer_scc_pop_zcta_10yr_annualized) %>% 
