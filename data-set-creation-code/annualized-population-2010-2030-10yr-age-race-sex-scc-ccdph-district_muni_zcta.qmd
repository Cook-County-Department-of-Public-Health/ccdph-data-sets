...
standard_age_groups_seer_scc_10yr_annualized_all <- standard_age_groups_seer_pop_scc_10yr_annualized %>%
  ...
  bind_rows(
    standard_age_groups_seer_scc_pop_muni_10yr_annualized
    ) %>%
  bind_rows(
    standard_age_groups_seer_scc_pop_zcta_10yr_annualized
    ) %>%
  select(-c(dif_2010_20))
...
dbWriteTable(con_inter_census,
         ...
         overwrite = TRUE,
         value = standard_age_groups_seer_scc_10yr_annualized_all,
         encoding = "latin1",
         fileEncoding="UTF-8")
```
