...
acs_age_pop_muni_clean <- acs_age_pop_muni %>%
...
write_csv(acs_age_pops_muni_clean, "acs-5yr-2019-age-sex-by-muni.csv")
...
write_csv(dec_age_pops_muni_clean, "decennial-2010-race-ethnicity-by-muni.csv")
