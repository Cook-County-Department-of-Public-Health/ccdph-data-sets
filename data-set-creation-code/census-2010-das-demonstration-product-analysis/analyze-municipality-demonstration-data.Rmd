---
title: 'Analysis of 2010 DAS Demonstration Product Data for Municipalities'
...
#Source file: NHGIS Vintage 2021-06-08 Nationwide Files Place

#Target variables: H72001 (total pop), H73002 (Hispanic), H73006 (not Hispanic, Black alone), H73008 (not Hispanic, Asian alone); demonstration product variables are appended "_dp", published 2010 variables are appended "_sf"

#Download zipped file of places data
download.file("https://assets.nhgis.org/differential-privacy/v20210608/nhgis_ppdd_20210608_place.zip", paste0(downloads_path, "places.zip"))
...
places <- read_csv(paste0(downloads_path, "nhgis_ppdd_20210608_place.csv")) %>%
  filter(state == 17) %>%
  select(gisjoin,
         name,
         total_pop_dp = H72001_dp,
         total_pop_sf = H72001_sf,
         hispanic_dp = H73002_dp,
         hispanic_sf = H73002_sf,
         black_dp = H73006_dp,
         black_sf = H73006_sf,
         asian_dp = H73008_dp,
         asian_sf = H73008_sf)
