...
```{r total_female_fifties_perplot}
#Plot percent change
...
```{r total_female_fifties_district}
...
```{r}
rmarkdown::render("C:/Users/burda/OneDrive - Cook County Health/DHC analysis/data-set-creation-code/census-2010-das-demonstration-product-analysis/DHC-municipality-sex-by-age-data.Rmd")
```
