...
For SCC, CCDPH, and health regions, race/ethnicity is crossed with sex so the final table carries both a `stratification` column (`"total"` plus each race/ethnicity category) and a separate `sex` column (`"total"`, `"male"`, `"female"`); the full population for a given age/year/geography is the row where `stratification == "total"` and `sex == "total"`. Municipality and ZCTA population is only available as a total (no race/sex breakdown), so those rows carry `stratification == "total"` and `sex == "total"` as well.
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_region <- standard_age_groups_seer %>% 
  left_join(pop_2010_region_total_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_region_total_10yr, by=c("order_age_10yr","name_region"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_region_10yr <- standard_age_groups_seer_pop_region %>% 
  group_by(name_region, 
           order_age_10yr,
           name_age_10yr) %>% 
  summarise(pop_2010 = sum(pop_2010),
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_region_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_region_10yr_annualized")
standard_age_groups_seer_pop_region_10yr_annualized <- standard_age_groups_seer_pop_region_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_region_total_10yr, 
   pop_2020_region_total_10yr,
   standard_age_groups_seer_pop_region_10yr)

```

### Municipality
Create total population by municipality by year table for suburban Cook County.
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_scc_pop_muni <- standard_age_groups_seer %>% 
  left_join(pop_2010_scc_muni_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_scc_muni_10yr, by=c("geoid_place", "order_age_10yr"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_scc_pop_muni_10yr <- standard_age_groups_seer_scc_pop_muni %>% 
  group_by(order_age_10yr,
           name_age_10yr,
           geoid_place,
           name_place) %>% 
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_scc_pop_muni_10yr
...
assign(value = atable, x = "standard_age_groups_seer_scc_pop_muni_10yr_annualized")
standard_age_groups_seer_scc_pop_muni_10yr_annualized <- standard_age_groups_seer_scc_pop_muni_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
rm(pop_2010_scc_muni_10yr, 
   pop_2020_scc_muni_10yr,
   standard_age_groups_seer_scc_pop_muni)

```

### ZCTA
Create total population by ZCTA by year table for suburban Cook County.
...
pop_2010_scc_zcta_10yr <-
  ...
  arrange(order_age_10yr) %>% 
  collect() %>% 
  filter(!grepl("^606", geoid_zcta)) %>% 
  mutate(pct_2010 = (pop_2010/sum(pop_2010)))

# import 2020 SCC total population data by year
pop_2020_scc_zcta_10yr <-
  tbl(con_inter_census,
      Id(schema = "ref",
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_scc_pop_zcta <- standard_age_groups_seer %>% 
  left_join(pop_2010_scc_zcta_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_scc_zcta_10yr, by=c("geoid_zcta", "order_age_10yr"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_scc_pop_zcta_10yr <- standard_age_groups_seer_scc_pop_zcta %>% 
  group_by(order_age_10yr,
           name_age_10yr,
           geoid_zcta) %>% 
  summarise(pop_2010 = sum(pop_2010),
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_scc_pop_zcta_10yr
...
assign(value = atable, x = "standard_age_groups_seer_scc_pop_zcta_10yr_annualized")
standard_age_groups_seer_scc_pop_zcta_10yr_annualized <- standard_age_groups_seer_scc_pop_zcta_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_scc_zcta_10yr, 
   pop_2020_scc_zcta_10yr,
   standard_age_groups_seer_scc_pop_zcta)
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_race_region <- standard_age_groups_seer %>% 
  left_join(pop_2010_region_race_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_region_race_10yr, by=c("order_age_10yr","name_region","race"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_race_region_10yr <- standard_age_groups_seer_pop_race_region %>% 
  group_by(name_region, 
           order_age_10yr,
           name_age_10yr,
           race) %>% 
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_race_region_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_race_region_10yr_annualized")
standard_age_groups_seer_pop_race_region_10yr_annualized <- standard_age_groups_seer_pop_race_region_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_region_race_10yr, 
   pop_2020_region_race_10yr,
   standard_age_groups_seer_pop_race_region_10yr)
...
# Join SCC population by sex, ethnicity data with standard age groups
standard_age_groups_seer_pop_sex <- standard_age_groups_seer %>% 
  left_join(pop_2010_ccdph_sex_10yr, by=c("order_age_10yr"), relationship = "many-to-many") %>% 
   left_join(pop_2020_ccdph_sex_10yr, by=c("order_age_10yr","sex"), relationship = "many-to-many")
...
# Join SCC total population data with standard age groups
standard_age_groups_seer_pop_sex_region <- standard_age_groups_seer %>% 
  left_join(pop_2010_region_sex_10yr, by=c("order_age_10yr")) %>% 
   left_join(pop_2020_region_sex_10yr, by=c("order_age_10yr","name_region","sex"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_sex_region_10yr <- standard_age_groups_seer_pop_sex_region %>% 
  group_by(name_region, 
           order_age_10yr,
           name_age_10yr,
           sex) %>% 
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_sex_region_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_sex_region_10yr_annualized")
standard_age_groups_seer_pop_sex_region_10yr_annualized <- standard_age_groups_seer_pop_sex_region_10yr_annualized %>% 
  relocate(pop_2010, .before = pop_2011) %>% 
  relocate(pop_2020, .after = pop_2019) %>% 
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_region_sex_10yr,
   pop_2020_region_sex_10yr,
   standard_age_groups_seer_pop_sex_region_10yr)

```

## Race by sex with SEER rates
Create population by race/ethnicity crossed with sex (i.e., male, female) by year table for suburban Cook County, CCDPH, and health region. This lets the final table report each race/ethnicity group broken out by sex, in addition to the race-only and sex-only tables built above.
...
# Join SCC population by race, ethnicity and sex data with standard age groups
standard_age_groups_seer_pop_race_sex <- standard_age_groups_seer %>%
...
# Create 10-year race, ethnicity and sex by age group population table
standard_age_groups_seer_pop_race_sex_10yr <- standard_age_groups_seer_pop_race_sex %>%
  group_by(order_age_10yr,
           name_age_10yr,
           race,
           sex) %>%
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_race_sex_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_race_sex_scc_10yr_annualized")
standard_age_groups_seer_pop_race_sex_scc_10yr_annualized <- standard_age_groups_seer_pop_race_sex_scc_10yr_annualized %>%
  relocate(pop_2010, .before = pop_2011) %>%
  relocate(pop_2020, .after = pop_2019) %>%
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
rm(pop_2010_scc_race_sex_10yr,
   pop_2020_scc_race_sex_10yr,
   standard_age_groups_seer_pop_race_sex_10yr)
...
# Join CCDPH population by race, ethnicity and sex data with standard age groups
standard_age_groups_seer_pop_race_sex <- standard_age_groups_seer %>%
  left_join(pop_2010_ccdph_race_sex_10yr, by=c("order_age_10yr"), relationship = "many-to-many") %>%
   left_join(pop_2020_ccdph_race_sex_10yr, by=c("order_age_10yr","race","sex"), relationship = "many-to-many")
...
assign(value = atable, x = "standard_age_groups_seer_pop_race_sex_ccdph_10yr_annualized")
standard_age_groups_seer_pop_race_sex_ccdph_10yr_annualized <- standard_age_groups_seer_pop_race_sex_ccdph_10yr_annualized %>%
  relocate(pop_2010, .before = pop_2011) %>%
  relocate(pop_2020, .after = pop_2019) %>%
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_ccdph_race_sex_10yr,
   pop_2020_ccdph_race_sex_10yr,
   standard_age_groups_seer_pop_race_sex_10yr)
...
# Join region population by race, ethnicity and sex data with standard age groups
standard_age_groups_seer_pop_race_sex_region <- standard_age_groups_seer %>%
  left_join(pop_2010_region_race_sex_10yr, by=c("order_age_10yr")) %>%
   left_join(pop_2020_region_race_sex_10yr, by=c("order_age_10yr","name_region","race","sex"))

# Create 10-year standard age group population table (2010, 2020 populations)
standard_age_groups_seer_pop_race_sex_region_10yr <- standard_age_groups_seer_pop_race_sex_region %>%
  group_by(name_region,
           order_age_10yr,
           name_age_10yr,
           race,
...
# Create 10-year standard age group population table (2010-2020 populations)
atable <- standard_age_groups_seer_pop_race_sex_region_10yr
...
assign(value = atable, x = "standard_age_groups_seer_pop_race_sex_region_10yr_annualized")
standard_age_groups_seer_pop_race_sex_region_10yr_annualized <- standard_age_groups_seer_pop_race_sex_region_10yr_annualized %>%
  relocate(pop_2010, .before = pop_2011) %>%
  relocate(pop_2020, .after = pop_2019) %>%
  pivot_longer(cols = pop_2010:pop_2030,
               names_to = "pop_year",
...
# remove unneeded tables
rm(pop_2010_region_race_sex_10yr,
   pop_2020_region_race_sex_10yr,
   standard_age_groups_seer_pop_race_sex_region_10yr)

```

# Write annualized population tables to SQL Server
Bind the total population, race, sex, race-by-sex, and municipality/ZCTA by year tables and write to SQL Server inter-census database. Each geography's rows carry both a `stratification` column (`"total"` plus each race/ethnicity category) and a `sex` column (`"total"`, `"male"`, `"female"`); the full population for an age/year/geography is the row where `stratification == "total"` and `sex == "total"`.

```{r}
# bind tables

# SCC
standard_age_groups_seer_scc_10yr_annualized_all <-
  # total population, across race/ethnicity and sex
  standard_age_groups_seer_pop_scc_10yr_annualized %>%
  mutate(stratification = "total",
         sex            = "total") %>%
  bind_rows(
    # total population (all race/ethnicity groups combined), by sex
    standard_age_groups_seer_pop_sex_scc_10yr_annualized %>%
      mutate(stratification = "total",
             sex            = str_to_lower(sex))
    ) %>%
  bind_rows(
    # population by race/ethnicity, combined across sex
    standard_age_groups_seer_pop_race_scc_10yr_annualized %>%
      rename(stratification = race) %>%
      mutate(sex = "total")
    ) %>%
  bind_rows(
    # population by race/ethnicity and sex
    standard_age_groups_seer_pop_race_sex_scc_10yr_annualized %>%
      rename(stratification = race) %>%
...
# CCDPH
standard_age_groups_seer_ccdph_10yr_annualized_all <-
  # total population, across race/ethnicity and sex
  ...
  bind_rows(
    # population by race/ethnicity and sex
    standard_age_groups_seer_pop_race_sex_ccdph_10yr_annualized %>%
      rename(stratification = race) %>%
      mutate(sex = str_to_lower(sex))
    ) %>%
  mutate(geoid = "ccdph",
...
# Health region
standard_age_groups_seer_region_10yr_annualized_all <-
  # total population, across race/ethnicity and sex
  standard_age_groups_seer_pop_region_10yr_annualized %>%
  mutate(stratification = "total",
         sex            = "total") %>%
  bind_rows(
    # total population (all race/ethnicity groups combined), by sex
    standard_age_groups_seer_pop_sex_region_10yr_annualized %>%
      mutate(stratification = "total",
             sex            = str_to_lower(sex))
    ) %>%
  bind_rows(
    # population by race/ethnicity, combined across sex
    standard_age_groups_seer_pop_race_region_10yr_annualized %>%
      rename(stratification = race) %>%
      mutate(sex = "total")
    ) %>%
  bind_rows(
    # population by race/ethnicity and sex
    standard_age_groups_seer_pop_race_sex_region_10yr_annualized %>%
      rename(stratification = race) %>%
      mutate(sex = str_to_lower(sex))
    ) %>%
  mutate(geoid = name_region,
         layer = "region")

# Muni (population is only available as a total; no race/sex breakdown source)
standard_age_groups_seer_scc_pop_muni_10yr_annualized_all <- standard_age_groups_seer_scc_pop_muni_10yr_annualized %>%
  mutate(sex   = "total",
         layer = "place")

# ZCTA (population is only available as a total; no race/sex breakdown source)
standard_age_groups_seer_scc_pop_zcta_10yr_annualized_all <- standard_age_groups_seer_scc_pop_zcta_10yr_annualized %>%
  mutate(sex   = "total",
         layer = "zip")

# Bind all geographies
standard_age_groups_seer_10yr_annualized_all <- 
  standard_age_groups_seer_scc_10yr_annualized_all %>% 
  bind_rows(standard_age_groups_seer_ccdph_10yr_annualized_all) %>%
  bind_rows(standard_age_groups_seer_region_10yr_annualized_all) %>%
  bind_rows(standard_age_groups_seer_scc_pop_muni_10yr_annualized_all) %>%
  bind_rows(standard_age_groups_seer_scc_pop_zcta_10yr_annualized_all) %>% 
  select(-c(name_region,
            dif_2010_20))
...
dbWriteTable(con_inter_census,
         Id(schema = "ref", table = "annualized-decennial-2010-2030-10yr-age-by-race-sex-scc-ccdph-region-muni-zcta"),
         overwrite = TRUE,
