...
# create 2020 decennial tracts by single-year age, sex for Cook County
```{r}
...
tract_age_sex_race_2020_attr <- tract_age_sex_race_2020 %>%
  ...
  arrange(geoid_tract_2020,
          ...
          race,
          col_number) %>%
  select(geoid_tract_2020, name_tract = NAME, sex, race, name_age_1yr:order_age_10yr, population, vintage, source)
